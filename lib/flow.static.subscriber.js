...
module.exports = {
            ...
            return async ({ topic, message }) => {
                ...
                try {
                    ...
                    if (subscription.emit) {
                        ...
                        await this.broker.call(this.publisher + ".emit", params, { meta: content.meta });
    ...
    created() {
        ...
        this.kafka = new Kafka({
            ...
            connectionTimeout: this.settings.connectionTimeout ||  defaults.connectionTimeout,
            retry: this.settings.retry || defaults.retry
        });
